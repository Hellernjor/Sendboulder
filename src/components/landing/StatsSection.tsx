...
const StatsSection = () => {
  return (
    <div className="bg-white/80 backdrop-blur-sm rounded-3xl p-8 md:p-12 mb-16 md:mb-24 border border-blue-200 shadow-lg">
      ...
      <div className="grid md:grid-cols-3 gap-8 md:gap-12 text-center">
        <div className="group">
          <div className="flex flex-col items-center mb-4">
            <div className="bg-gradient-to-r from-yellow-500 to-orange-500 p-3 rounded-xl mb-4 shadow-md">
        ...
        <div className="group">
          <div className="flex flex-col items-center mb-4">
            <div className="bg-gradient-to-r from-green-500 to-blue-500 p-3 rounded-xl mb-4 shadow-md">
        ...
        <div className="group">
          <div className="flex flex-col items-center mb-4">
            <div className="bg-gradient-to-r from-blue-500 to-purple-500 p-3 rounded-xl mb-4 shadow-md">
